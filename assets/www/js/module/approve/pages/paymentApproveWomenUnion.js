...
function getNextStep() {
    if(instance.isOperator){
        switch (instance.currentStep){
            case "发起流程":
                instance.nextStep = "妇工委负责人审批";
                break;
            case "妇工委负责人审批":
                instance.nextStep = "负责人审批";
                break;
            case "负责人审批":
...
function getContent() {
    ...
    switch (instance.currentStep) {
        case "发起流程":
            ...
            break;
        case "妇工委负责人审批":
            content.adviceManager = $("#adviceManager").val();
            content.historyAdviceManager = "adviceManager";
            content.signatureManager = user.id;
            content.timeAdviceManager = $("#timeAdviceManager").text();
            break;
        case "负责人审批":
...
function initContentInterface() {
    ...
    if(instance.launcherSection != "领导"){
        ...
        initManagerApproveControl(instance.currentStep == "妇工委负责人审批",undefined);//科长审批信息显示控制
        initSectionApproveControl(instance.currentStep == "负责人审批",timeAdviceManager);//科长审批信息显示控制
...
$(document).ready(
    function init() {
        initCommon("paymentApproveWomenUnion");
